...
public class DeleteRecurringBillCommandHandler implements CommandHandler<DeleteRecurringBillCommand> {
    private final RecurringBillRepository recurringBillRepository;

    @Override
    public RecurringBill handle(@NonNull DeleteRecurringBillCommand command) {
