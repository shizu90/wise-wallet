...
import dev.gabriel.wisewallet.budget.infrastructure.services.dtos.BudgetItemRequestDto;
import dev.gabriel.wisewallet.budget.infrastructure.services.dtos.BudgetListResponseDto;
import dev.gabriel.wisewallet.budget.infrastructure.services.dtos.BudgetRequestDto;
import dev.gabriel.wisewallet.budget.infrastructure.services.dtos.BudgetResponseDto;
import dev.gabriel.wisewallet.budget.infrastructure.services.dtos.mapper.BudgetDtoMapper;
...
public class BudgetService {
    ...
    public BudgetListResponseDto getBudgets(UUID userId, String name, int page, int limit) {
        return dtoMapper.toResponseDto(budgetProjectionRepository.find(userId, name, PageRequest.of(page, limit)));
    }
